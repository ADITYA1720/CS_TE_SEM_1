...
public class Product {
	...
	public void setProductID(int r) {
		this.prodID = r;
	}
...
//			updateProduct(this.productName, this.price, this.quantity-amount);
	...
	public void updateProduct() {
		String query = "UPDATE `product` SET `productName`='"+productName+"', `price`="+price+", `quantity`="+quantity+" WHERE `productId`='"+this.prodID+"';";
		Connection con = null;
        Statement st = null;
		System.out.println(query);
        try {
	...
	public void deleteProduct() {
		String query1 = "DELETE FROM `product` WHERE `productId`='"+this.prodID+"';";
		Connection con = null;
        Statement st = null;
