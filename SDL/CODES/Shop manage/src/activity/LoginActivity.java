...
public class LoginActivity extends JFrame implements ActionListener {
	...
	private JLabel title, header, usernameLabel, passwordLabel, title1, title2;
	private JTextField usernameTF;
	private JPasswordField passwordF;
	
	
	public LoginActivity(int a) {
		super("Login");
		...
		title1.setBounds(230, 130, 555, 55);
//		title1.setOpaque(true);
//		title1.setBorder(new EmptyBorder(0,20,0,0));
		title1.setFont(Theme.FONT_TITLE);
		title1.setForeground(Theme.COLOR_TITLE);
		panel.add(title1);
		}	
		else {
			title2 = new JLabel("Customer Login");
			title2.setBounds(230, 130, 555, 55);
//			title2.setOpaque(true);
//			title2.setBorder(new EmptyBorder(0,20,0,0));
			title2.setFont(Theme.FONT_TITLE);
			title2.setForeground(Theme.COLOR_TITLE);
			panel.add(title2);
