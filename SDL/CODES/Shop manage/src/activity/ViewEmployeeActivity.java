...
public class ViewEmployeeActivity extends JFrame implements ActionListener {
	...
	JComboBox byWhatCB;
	JTable table;
	private JButton buttonLogout, buttonBack, buttonCheck, buttonAddEmployee, buttonUpdate, buttonDelete;
	...
	public void actionPerformed(ActionEvent ae) {
		...
		/*
		 * else if (ae.getSource().equals(buttonUpdate)) { this.setVisible(false); new
		 * UpdateEmployeeActivity(this, employee).setVisible(true); }
		 */
